...
from kubeapps_client.models.v1alpha1_context import V1alpha1Context  # noqa: E501
from kubeapps_client.rest import ApiException


class TestV1alpha1Context(unittest.TestCase):
    """V1alpha1Context unit test stubs"""
    ...
    def testV1alpha1Context(self):
        """Test V1alpha1Context"""
        # FIXME: construct object with mandatory attributes with example values
        # model = kubeapps_client.models.v1alpha1_context.V1alpha1Context()  # noqa: E501
        pass
