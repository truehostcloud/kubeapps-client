...
from kubeapps_client.api.repositories_service_api import RepositoriesServiceApi  # noqa: E501
from kubeapps_client.rest import ApiException


class TestRepositoriesServiceApi(unittest.TestCase):
    """RepositoriesServiceApi unit test stubs"""

    def setUp(self):
        self.api = RepositoriesServiceApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_repositories_service_add_package_repository(self):
        """Test case for repositories_service_add_package_repository

        """
        pass

    def test_repositories_service_delete_package_repository(self):
        """Test case for repositories_service_delete_package_repository

        """
        pass

    def test_repositories_service_get_package_repository_detail(self):
        """Test case for repositories_service_get_package_repository_detail

        """
        pass

    def test_repositories_service_get_package_repository_permissions(self):
        """Test case for repositories_service_get_package_repository_permissions

        """
        pass

    def test_repositories_service_get_package_repository_summaries(self):
        """Test case for repositories_service_get_package_repository_summaries

        """
        pass

    def test_repositories_service_update_package_repository(self):
        """Test case for repositories_service_update_package_repository
