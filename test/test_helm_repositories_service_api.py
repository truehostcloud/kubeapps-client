...
from kubeapps_client.api.helm_repositories_service_api import HelmRepositoriesServiceApi  # noqa: E501
from kubeapps_client.rest import ApiException


class TestHelmRepositoriesServiceApi(unittest.TestCase):
    """HelmRepositoriesServiceApi unit test stubs"""

    def setUp(self):
        self.api = HelmRepositoriesServiceApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_helm_repositories_service_add_package_repository(self):
        """Test case for helm_repositories_service_add_package_repository

        AddPackageRepository add an existing package repository to the set of ones already managed by the Helm plugin  # noqa: E501
        """
        pass

    def test_helm_repositories_service_delete_package_repository(self):
        """Test case for helm_repositories_service_delete_package_repository

        """
        pass

    def test_helm_repositories_service_get_package_repository_detail(self):
        """Test case for helm_repositories_service_get_package_repository_detail

        """
        pass

    def test_helm_repositories_service_get_package_repository_permissions(self):
        """Test case for helm_repositories_service_get_package_repository_permissions

        """
        pass

    def test_helm_repositories_service_get_package_repository_summaries(self):
        """Test case for helm_repositories_service_get_package_repository_summaries

        """
        pass

    def test_helm_repositories_service_update_package_repository(self):
        """Test case for helm_repositories_service_update_package_repository
