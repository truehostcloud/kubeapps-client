...
class V1alpha1CheckNamespaceExistsResponse(object):
    ...
    def __init__(self, exists=None):  # noqa: E501
        """V1alpha1CheckNamespaceExistsResponse - a model defined in Swagger"""  # noqa: E501
        self._exists = None
    ...
    @property
    def exists(self):
        """Gets the exists of this V1alpha1CheckNamespaceExistsResponse.  # noqa: E501


        :return: The exists of this V1alpha1CheckNamespaceExistsResponse.  # noqa: E501
        :rtype: bool
        """
        return self._exists
    ...
    def exists(self, exists):
        """Sets the exists of this V1alpha1CheckNamespaceExistsResponse.


        :param exists: The exists of this V1alpha1CheckNamespaceExistsResponse.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1CheckNamespaceExistsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1CheckNamespaceExistsResponse):
            return False
