...
class V1alpha1GetPackageRepositoryPermissionsResponse(object):
    ...
    """
    swagger_types = {
        'permissions': 'list[V1alpha1PackageRepositoriesPermissions]'
    }
    ...
    def __init__(self, permissions=None):  # noqa: E501
        """V1alpha1GetPackageRepositoryPermissionsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def permissions(self):
        """Gets the permissions of this V1alpha1GetPackageRepositoryPermissionsResponse.  # noqa: E501


        :return: The permissions of this V1alpha1GetPackageRepositoryPermissionsResponse.  # noqa: E501
        :rtype: list[V1alpha1PackageRepositoriesPermissions]
        """
        return self._permissions

    @permissions.setter
    def permissions(self, permissions):
        """Sets the permissions of this V1alpha1GetPackageRepositoryPermissionsResponse.


        :param permissions: The permissions of this V1alpha1GetPackageRepositoryPermissionsResponse.  # noqa: E501
        :type: list[V1alpha1PackageRepositoriesPermissions]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GetPackageRepositoryPermissionsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1GetPackageRepositoryPermissionsResponse):
            return False
