...
class V1alpha1UpdatePackageRepositoryResponse(object):
    ...
    def __init__(self, package_repo_ref=None):  # noqa: E501
        """V1alpha1UpdatePackageRepositoryResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def package_repo_ref(self):
        """Gets the package_repo_ref of this V1alpha1UpdatePackageRepositoryResponse.  # noqa: E501


        :return: The package_repo_ref of this V1alpha1UpdatePackageRepositoryResponse.  # noqa: E501
    ...
    def package_repo_ref(self, package_repo_ref):
        """Sets the package_repo_ref of this V1alpha1UpdatePackageRepositoryResponse.


        :param package_repo_ref: The package_repo_ref of this V1alpha1UpdatePackageRepositoryResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1UpdatePackageRepositoryResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1UpdatePackageRepositoryResponse):
            return False
