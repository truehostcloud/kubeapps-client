...
class V1alpha1VersionReference(object):
    ...
    def __init__(self, version=None):  # noqa: E501
        """V1alpha1VersionReference - a model defined in Swagger"""  # noqa: E501
        self._version = None
    ...
    @property
    def version(self):
        """Gets the version of this V1alpha1VersionReference.  # noqa: E501

        The format of the version constraint depends on the backend. For example, for a flux v2 and Carvel it's a semver expression, such as \">=10.3 < 10.4\"  # noqa: E501

        :return: The version of this V1alpha1VersionReference.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this V1alpha1VersionReference.

        The format of the version constraint depends on the backend. For example, for a flux v2 and Carvel it's a semver expression, such as \">=10.3 < 10.4\"  # noqa: E501

        :param version: The version of this V1alpha1VersionReference.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1VersionReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1VersionReference):
            return False
