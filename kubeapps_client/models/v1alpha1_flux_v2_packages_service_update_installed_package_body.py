...
class V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody(object):
    ...
    def __init__(self, installed_package_ref=None, pkg_version_reference=None, values=None, reconciliation_options=None):  # noqa: E501
        """V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody - a model defined in Swagger"""  # noqa: E501
    ...
    def installed_package_ref(self):
        """Gets the installed_package_ref of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501


        :return: The installed_package_ref of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    def installed_package_ref(self, installed_package_ref):
        """Sets the installed_package_ref of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.


        :param installed_package_ref: The installed_package_ref of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    def pkg_version_reference(self):
        """Gets the pkg_version_reference of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501


        :return: The pkg_version_reference of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    def pkg_version_reference(self, pkg_version_reference):
        """Sets the pkg_version_reference of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.


        :param pkg_version_reference: The pkg_version_reference of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
        ...
        :return: The values of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
        :rtype: str
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.

        An optional serialized values string to be included when templating a package in the format expected by the plugin. Included when the backend format doesn't use secrets or configmaps for values or supports both. These values are layered on top of any values refs above, when relevant.  # noqa: E501

        :param values: The values of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
        :type: str
        """
    ...
    def reconciliation_options(self):
        """Gets the reconciliation_options of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501


        :return: The reconciliation_options of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    def reconciliation_options(self, reconciliation_options):
        """Sets the reconciliation_options of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.


        :param reconciliation_options: The reconciliation_options of this V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1FluxV2PackagesServiceUpdateInstalledPackageBody):
            return False
