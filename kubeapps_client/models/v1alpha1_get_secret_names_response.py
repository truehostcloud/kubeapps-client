...
class V1alpha1GetSecretNamesResponse(object):
    ...
    """
    swagger_types = {
        'secret_names': 'dict(str, V1alpha1SecretType)'
    }
    ...
    def __init__(self, secret_names=None):  # noqa: E501
        """V1alpha1GetSecretNamesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def secret_names(self):
        """Gets the secret_names of this V1alpha1GetSecretNamesResponse.  # noqa: E501

        The list of Service Account names.  # noqa: E501

        :return: The secret_names of this V1alpha1GetSecretNamesResponse.  # noqa: E501
        :rtype: dict(str, V1alpha1SecretType)
        """
        return self._secret_names

    @secret_names.setter
    def secret_names(self, secret_names):
        """Sets the secret_names of this V1alpha1GetSecretNamesResponse.

        The list of Service Account names.  # noqa: E501

        :param secret_names: The secret_names of this V1alpha1GetSecretNamesResponse.  # noqa: E501
        :type: dict(str, V1alpha1SecretType)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GetSecretNamesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1GetSecretNamesResponse):
            return False
