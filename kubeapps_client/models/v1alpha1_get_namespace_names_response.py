...
class V1alpha1GetNamespaceNamesResponse(object):
    ...
    attribute_map = {
        'namespace_names': 'namespaceNames'
    }

    def __init__(self, namespace_names=None):  # noqa: E501
        """V1alpha1GetNamespaceNamesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def namespace_names(self):
        """Gets the namespace_names of this V1alpha1GetNamespaceNamesResponse.  # noqa: E501

        The list of Namespace names.  # noqa: E501

        :return: The namespace_names of this V1alpha1GetNamespaceNamesResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._namespace_names

    @namespace_names.setter
    def namespace_names(self, namespace_names):
        """Sets the namespace_names of this V1alpha1GetNamespaceNamesResponse.

        The list of Namespace names.  # noqa: E501

        :param namespace_names: The namespace_names of this V1alpha1GetNamespaceNamesResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GetNamespaceNamesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1GetNamespaceNamesResponse):
            return False
