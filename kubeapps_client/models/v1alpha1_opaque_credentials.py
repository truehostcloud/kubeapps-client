...
class V1alpha1OpaqueCredentials(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """V1alpha1OpaqueCredentials - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this V1alpha1OpaqueCredentials.  # noqa: E501


        :return: The data of this V1alpha1OpaqueCredentials.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this V1alpha1OpaqueCredentials.


        :param data: The data of this V1alpha1OpaqueCredentials.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1OpaqueCredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1OpaqueCredentials):
            return False
