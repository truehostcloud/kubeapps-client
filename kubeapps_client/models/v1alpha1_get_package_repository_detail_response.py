...
class V1alpha1GetPackageRepositoryDetailResponse(object):
    ...
    """
    swagger_types = {
        'detail': 'V1alpha1PackageRepositoryDetail'
    }
    ...
    def __init__(self, detail=None):  # noqa: E501
        """V1alpha1GetPackageRepositoryDetailResponse - a model defined in Swagger"""  # noqa: E501
        self._detail = None
    ...
    @property
    def detail(self):
        """Gets the detail of this V1alpha1GetPackageRepositoryDetailResponse.  # noqa: E501


        :return: The detail of this V1alpha1GetPackageRepositoryDetailResponse.  # noqa: E501
        :rtype: V1alpha1PackageRepositoryDetail
        """
        return self._detail

    @detail.setter
    def detail(self, detail):
        """Sets the detail of this V1alpha1GetPackageRepositoryDetailResponse.


        :param detail: The detail of this V1alpha1GetPackageRepositoryDetailResponse.  # noqa: E501
        :type: V1alpha1PackageRepositoryDetail
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GetPackageRepositoryDetailResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1GetPackageRepositoryDetailResponse):
            return False
