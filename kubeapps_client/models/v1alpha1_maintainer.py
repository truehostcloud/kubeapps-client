...
class V1alpha1Maintainer(object):
    ...
    def __init__(self, name=None, email=None):  # noqa: E501
        """V1alpha1Maintainer - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._email = None
    ...
    @property
    def name(self):
        """Gets the name of this V1alpha1Maintainer.  # noqa: E501

        A maintainer name  # noqa: E501

        :return: The name of this V1alpha1Maintainer.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1alpha1Maintainer.

        A maintainer name  # noqa: E501

        :param name: The name of this V1alpha1Maintainer.  # noqa: E501
        :type: str
        """
    ...
    @property
    def email(self):
        """Gets the email of this V1alpha1Maintainer.  # noqa: E501

        A maintainer email  # noqa: E501

        :return: The email of this V1alpha1Maintainer.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this V1alpha1Maintainer.

        A maintainer email  # noqa: E501

        :param email: The email of this V1alpha1Maintainer.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1Maintainer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1Maintainer):
            return False
