...
class InstalledPackageReference(object):
    ...
    def __init__(self, context=None, plugin=None):  # noqa: E501
        """InstalledPackageReference - a model defined in Swagger"""  # noqa: E501
        self._context = None
        self._plugin = None
    ...
    @property
    def context(self):
        """Gets the context of this InstalledPackageReference.  # noqa: E501

        The context (cluster/namespace) for the package.  # noqa: E501

        :return: The context of this InstalledPackageReference.  # noqa: E501
        :rtype: object
        """
    ...
    def context(self, context):
        """Sets the context of this InstalledPackageReference.

        The context (cluster/namespace) for the package.  # noqa: E501

        :param context: The context of this InstalledPackageReference.  # noqa: E501
        :type: object
        """
    ...
    @property
    def plugin(self):
        """Gets the plugin of this InstalledPackageReference.  # noqa: E501


        :return: The plugin of this InstalledPackageReference.  # noqa: E501
    ...
    def plugin(self, plugin):
        """Sets the plugin of this InstalledPackageReference.


        :param plugin: The plugin of this InstalledPackageReference.  # noqa: E501
        :type: V1alpha1Plugin
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InstalledPackageReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstalledPackageReference):
            return False
