...
class V1alpha1InstalledPackageStatusStatusReason(object):
    ...
    allowed enum values
    """
    UNSPECIFIED = "STATUS_REASON_UNSPECIFIED"
    INSTALLED = "STATUS_REASON_INSTALLED"
    UNINSTALLED = "STATUS_REASON_UNINSTALLED"
    FAILED = "STATUS_REASON_FAILED"
    PENDING = "STATUS_REASON_PENDING"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """V1alpha1InstalledPackageStatusStatusReason - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1InstalledPackageStatusStatusReason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1InstalledPackageStatusStatusReason):
            return False
