...
class V1alpha1Context(object):
    ...
    def __init__(self, cluster=None, namespace=None):  # noqa: E501
        """V1alpha1Context - a model defined in Swagger"""  # noqa: E501
        self._cluster = None
    ...
    @property
    def cluster(self):
        """Gets the cluster of this V1alpha1Context.  # noqa: E501

        A cluster name can be provided to target a specific cluster if multiple clusters are configured, otherwise all clusters will be assumed.  # noqa: E501

        :return: The cluster of this V1alpha1Context.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster(self, cluster):
        """Sets the cluster of this V1alpha1Context.

        A cluster name can be provided to target a specific cluster if multiple clusters are configured, otherwise all clusters will be assumed.  # noqa: E501

        :param cluster: The cluster of this V1alpha1Context.  # noqa: E501
        :type: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this V1alpha1Context.

        A namespace must be provided if the context of the operation is for a resource or resources in a particular namespace. For requests to list items, not including a namespace here implies that the context for the request is everything the requesting user can read, though the result can be filtered by any filtering options of the request. Plugins may choose to return Unimplemented for some queries for which we do not yet have a need.  # noqa: E501

        :param namespace: The namespace of this V1alpha1Context.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1Context, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1Context):
            return False
