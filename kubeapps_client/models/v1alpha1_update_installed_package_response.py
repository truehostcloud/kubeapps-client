...
class V1alpha1UpdateInstalledPackageResponse(object):
    ...
    def __init__(self, installed_package_ref=None):  # noqa: E501
        """V1alpha1UpdateInstalledPackageResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def installed_package_ref(self):
        """Gets the installed_package_ref of this V1alpha1UpdateInstalledPackageResponse.  # noqa: E501


        :return: The installed_package_ref of this V1alpha1UpdateInstalledPackageResponse.  # noqa: E501
    ...
    def installed_package_ref(self, installed_package_ref):
        """Sets the installed_package_ref of this V1alpha1UpdateInstalledPackageResponse.


        :param installed_package_ref: The installed_package_ref of this V1alpha1UpdateInstalledPackageResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1UpdateInstalledPackageResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1UpdateInstalledPackageResponse):
            return False
