...
class V1alpha1SecretKeyReference(object):
    ...
    def __init__(self, name=None, key=None):  # noqa: E501
        """V1alpha1SecretKeyReference - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._key = None
    ...
    @property
    def name(self):
        """Gets the name of this V1alpha1SecretKeyReference.  # noqa: E501


        :return: The name of this V1alpha1SecretKeyReference.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1alpha1SecretKeyReference.


        :param name: The name of this V1alpha1SecretKeyReference.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key(self):
        """Gets the key of this V1alpha1SecretKeyReference.  # noqa: E501


        :return: The key of this V1alpha1SecretKeyReference.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this V1alpha1SecretKeyReference.


        :param key: The key of this V1alpha1SecretKeyReference.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1SecretKeyReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1SecretKeyReference):
            return False
